...
const Alumni = () => {
  ...
  const alumniStories = [
    ...
    },
    {
      ...
      storySummary: 'Mohammed is making a difference in global health.',
      fullStory:
        'Mohammed joined SLSU-AP in 2016, balancing studies with organizing health awareness events. After earning his degree in Public Health from GITAM University, he worked with NGOs in India before joining a global health consultancy. “SLSU-AP taught me resilience and community spirit,” he says. He now advises on health projects in Sierra Leone and beyond, often returning to inspire our members.',
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Alumni Network */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Alumni Network</h2>
          <p className="text-gray-600 mb-4">
            The SLSU-AP Alumni Network connects past members with current students, faculty, and each other. Our alumni are a vital part of our community, offering mentorship, career guidance, and support for union initiatives.
          </p>
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Why Join?</h3>
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">How to Get Involved</h3>
          <p className="text-gray-600 mb-4">
            If you’re a former SLSU-AP member, we’d love to reconnect! Register with us by filling out a simple form—email{' '}
            <a href="mailto:alumni@slsuap.org" className="text-green-800 hover:underline">
              alumni@slsuap.org
            </a>{' '}
            with your name, graduation year, and contact details. You can also join our{' '}
        ...
        {/* Alumni Stories */}
        <div>
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Alumni Stories</h2>
          {alumniStories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {alumniStories.map((alumni) => (
                <div key={alumni.id} className="bg-gray-50 p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    {expandedStory === alumni.id ? alumni.fullStory : alumni.storySummary}
                  </p>
                  <button
